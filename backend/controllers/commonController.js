...
exports.signup = Model => catchAsync(async (req, res, next) => {
  const newUser = await Model.create({
    ...
    age : req.body.age,
    city : req.body.city,
    yourIntrest : req.body.yourIntrest,
...
exports.addSomeData = Model => catchAsync(async (req, res, next) => {
  ...
  user.yourIntrest = req.body.yourIntrest;
...
///All user type controller
  
  exports.getAllUsers = Model => catchAsync(async (req, res, next) => {
  ...
  exports.updateMe = Model => catchAsync(async (req, res, next) => {
  ...
  exports.deleteMe = Model => catchAsync(async (req, res, next) => {
